...
| Doc | Read it when |
|---|---|
| [https://agent-dev-kit.devpipe.net/](https://agent-dev-kit.devpipe.net/) | **Live Web Platform.** Interactive showcase, terminal simulator & 25-skills explorer (source: `agent-dev-kit-web`, a separate repo) |
| [how-it-fits-together.md](how-it-fits-together.md) | You want the one map: runtimes → behavior → orchestration → gates |
| [skills-catalog.md](skills-catalog.md) | You want to know what the 25 skills do and what triggers them |
