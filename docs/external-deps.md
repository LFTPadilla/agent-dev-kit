...
| **Superpowers** (`obra/superpowers`) | Execution discipline (TDD, systematic debugging, verification evidence, review reception) | Antigravity: `agy plugin install https://github.com/obra/superpowers`; Claude: `/plugin install superpowers@superpowers-marketplace`; skills CLI: `npx skills add obra/superpowers` |
