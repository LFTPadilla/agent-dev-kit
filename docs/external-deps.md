...
| **caveman** | Compressed agent talk | Codex: `./scripts/install-codex-workhorse.sh`; Claude: `/plugin marketplace add JuliusBrussee/caveman` then `/plugin install caveman@caveman` |
| **ponytail** | Minimal diffs / YAGNI build mode | Codex: `./scripts/install-codex-workhorse.sh`; Claude: `/plugin marketplace add DietrichGebert/ponytail` then `/plugin install ponytail@ponytail` |
