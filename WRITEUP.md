...
Skill distribution is also layered: this marketplace ships the curated 28;
...
1. **`orchestrate`** — lean native orchestrator: decompose, delegate bounded
   briefs to host workers, verify on disk, cap parallel writers at 3.
2. **Agent Tutor Orchestrator** — strict pure orchestrator: holds the
