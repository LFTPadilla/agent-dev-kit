...
metadata: {"author":"Agents365-ai","version":"1.14.0","upstream":"https://github.com/Agents365-ai/drawio-skill"}
---

# Draw.io Diagrams

> Vendored from [Agents365-ai/drawio-skill](https://github.com/Agents365-ai/drawio-skill) (MIT). See `LICENSE` in this directory and the repo's `ATTRIBUTION.md`.
